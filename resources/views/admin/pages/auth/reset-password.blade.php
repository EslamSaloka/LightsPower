...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" @if(\App::getLocale() == "ar")  style="direction:rtl" @endif>
	<head>
		...
		<!-- Title -->
		<title>
            @lang('إستعاده كلمة المرور') | {{ env('APP_NAME') }} - @lang('Dashboard')
        </title>
						...
						<div class="row row-sm">
							<div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
								<div class="mt-5 pt-4 p-2 pos-absolute">
									...
									<img src="{{ getSettings("logo",asset('/dashboard.svg')) }}" class="ht-100 mb-0" alt="user" style="    margin-right: 49px;">
								</div>
							</div>
                                            ...
                                            <form style="direction: ltr;" class="form-horizontal" method="POST" action="{{ route('admin.resetPassword.send') }}">
                                                ...
                                                <div class="mb-3" style="text-align: end;">
                                                    ...
                                                    <input
														...
														style=" direction: rtl; "
                                                        value="{{ old('password') }}"
                                                        placeholder="@lang('إدخل كلمة المرور الجديده')">
                                                        @error('password')
                                                            <span class="text-danger">
                                                                {{ $message }}
                                                            </span>
                                                ...
                                                <div class="mt-3 d-grid">
                                                    <button class="btn btn-primary waves-effect waves-light" type="submit">@lang('حفظ التغييرات')</button>
                                                </div>
                                            </form>
										</div>
									</div>
